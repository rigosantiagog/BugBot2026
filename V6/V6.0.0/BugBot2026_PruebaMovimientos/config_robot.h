...
//   en los cables paralelos y puede colapsar el voltaje de alimentación de las
//   ESP32 (motores Y anillo), causando un reset (brownout).
//
...
//
// ACTUALIZACIÓN v5 — RAMPA_DURACION_MS subida de 400 a 700 ms:
//   El log de pruebas mostró que, incluso con la rampa de 400ms y PWM=90,
//   el arranque de los motores seguía provocando basura en el serial y
//   reinicios en AMBAS ESP32 (motores y anillo) por caída de voltaje. Se
//   sube la rampa a 700ms como mitigación de software adicional mientras se
//   resuelve la causa raíz en hardware (ver notas de abajo y el doc de
//   proyecto "Brownout-Ruido-Serial-Motores.md"). Esto SOLO reduce el pico
//   instantáneo de corriente; no reemplaza los capacitores de bulk en cada
//   TB6612FNG ni una fuente/batería que aguante la demanda real.
// ============================================================================
...
#define RAMPA_DURACION_MS        700  // Milisegundos para subir de ARRANQUE a OBJETIVO
                                      // Subido de 400 a 700ms (v5): mas margen mientras se
                                      // resuelve la causa raiz en hardware (ver SECCION 7 arriba)
