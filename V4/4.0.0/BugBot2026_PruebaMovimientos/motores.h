...
void motores_inicializar() {
  Debug.println("[MOTORES] Configurando 4 motores y 2 drivers TB6612FNG...");
  ...
  Debug.println("[MOTORES] STBY=LOW — drivers deshabilitados durante init");
  ...
  Debug.println("[MOTORES] Driver #1 (FR/RR): pines de direccion configurados");
  ...
  Debug.println("[MOTORES] Driver #2 (FL/RL): pines de direccion configurados");
  ...
  Debug.print("[MOTORES] PWM configurado: ");
  Debug.print(PWM_FREQ_HZ);
  Debug.print(" Hz, ");
  Debug.print(PWM_RESOLUCION_BITS);
  Debug.println(" bits (0-255)");
  ...
  Debug.println("[MOTORES] STBY=HIGH — ambos drivers habilitados");
  Debug.println("[MOTORES] Inicializacion completa. Robot listo para moverse.");
}
...
void mover_mecanum_con_rampa(float adelante, float lateral, float giro,
  ...
  Debug.print("[RAMPA] Acelerando de PWM=");
  Debug.print(VELOCIDAD_ARRANQUE);   // Velocidad inicial de la rampa
  Debug.print(" a PWM=");
  Debug.print(velocidadObjetivo);    // Velocidad objetivo al final
  Debug.print(" en ");
  Debug.print(RAMPA_DURACION_MS);    // Duración de la rampa
  Debug.println(" ms...");
  ...
  Debug.println("[RAMPA] Velocidad objetivo alcanzada.");
}
